...
def get_args():
    ...
    parser.add_argument('--num-good-agents', type=int, default=3)
    parser.add_argument('--num-adversaries', type=int, default=0)
    parser.add_argument('--num-entities', type=int, help='number of entities in competitive scenario')
    ...
    parser.add_argument('--obs-masking-dist', type=float, default=0.5, help='distance to restrict comms')
    ...
    parser.add_argument('--num-frames', type=int, default=int(10e8), help='number of frames to train (default: 50e6)')
    parser.add_argument('--arena-size', type=float, default=1, help='size of arena')

    # evaluation
    parser.add_argument('--num-eval-episodes', type=int, default=100, help='number of episodes to evaluate with')
    ...
    parser.add_argument('--save-interval', type=int, default=100, help='save interval, one save per n updates (default: 200)')
    ...
    args.save_dir = '../marl_transfer1/marlsave/'+args.save_dir
